...
# ============================================================
FRAMEWORK_VERSION = "experiment-v3-collection-diagnostics-20260816"
...
def execute_and_report(chat_id, start_date=None, end_date=None):
    ...
    try:
        ...
        send_telegram_document(
            chat_id, f"candleview_collection_diagnostics_{run_id}.csv", collection_bytes,
            caption="거래소 수집 진단: 요청·성공·API오류·봉수미달·사용가능 심볼·오류 예시"
        )
        ...
        send_telegram_document(
            ...
            caption="실험 요약: 전체·거래소별 평가/None/진단성립/통과/중복제거 통계 (수집 상태는 diagnostics CSV 참조)"
        )
