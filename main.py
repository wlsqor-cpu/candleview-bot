...
def run_event_collection(chat_id, ex_name, symbol, ref_date_str):
    ...
    fetch_span_days = max_offset + FC_EVENT_COLLECT_LOOKBACK_BUFFER + 5
    ...
    btc_daily_bars = None
    try:
        btc_daily_bars = exchange_class.fetch_ohlcv(f"BTC/{quote}", timeframe="1d", since=since_ms, limit=200)
    except Exception as e:
